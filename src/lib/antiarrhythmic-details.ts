...
export const DRUG_DETAILS: Record<string, DrugDetails> = {
  Ivabradine: {
    ...
    interactions: [
      "CONTRAINDICATED — Strong CYP3A4 inhibitors: ketoconazole, itraconazole, clarithromycin, telithromycin, ritonavir, nelfinavir, nefazodone, cobicistat — ≥ 7-fold ↑ ivabradine exposure with excessive bradycardia and QT prolongation",
      "AVOID — Moderate CYP3A4 inhibitors: diltiazem, verapamil — dual mechanism (↑ level + intrinsic HR-slowing); if unavoidable start ivabradine at 2.5 mg BID and monitor HR",
      "AVOID — Grapefruit juice (intestinal CYP3A4 inhibition) — ~2-fold ↑ AUC; counsel patient",
      "AVOID — Other rate-slowing AV-nodal blockers stacked: digoxin, amiodarone, dronedarone, sotalol — additive bradycardia, ↑ AV block risk; check HR before/after initiation",
      "CAUTION — β-blockers (metoprolol, bisoprolol, carvedilol): expected co-therapy in HFrEF but requires HR monitoring; target resting HR 50–60 bpm, hold ivabradine if HR <50 or symptomatic",
      "CAUTION — QT-prolonging drugs (class Ia/III antiarrhythmics, macrolides, azoles, methadone, TCAs, ondansetron) — additive QT; avoid combination when possible",
      "REDUCED EFFICACY — CYP3A4 inducers: rifampin, phenytoin, carbamazepine, phenobarbital, St John's wort — ↓ ivabradine level and clinical effect",
      "CAUTION — Negative chronotropes (clonidine, ivermectin, mefloquine, pilocarpine, anticholinesterases) — additive bradycardia",
      "CAUTION — Potassium-losing diuretics (furosemide, HCTZ) — hypokalemia lowers arrhythmia threshold; keep K⁺ >4.0, Mg²⁺ >2.0",
    ],
    adverse: [
      "Bradycardia",
