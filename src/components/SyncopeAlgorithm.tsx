        ...
        <Collapsible open={showRedFlags} onOpenChange={setShowRedFlags}>
            ...
            <button className="w-full">
              <CardHeader className="pb-2">
                <CardTitle className="text-base flex items-center justify-between">
                  ...
                  {showRedFlags ? <ChevronUp className="w-4 h-4 text-muted-foreground" /> : <ChevronDown className="w-4 h-4 text-muted-foreground" />}
                </CardTitle>
              </CardHeader>
            </button>
          </CollapsibleTrigger>
          <CollapsibleContent>
            <CardContent className="pt-2 space-y-3">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div className="p-3 rounded-lg bg-destructive/5 border border-destructive/20">
                  ...
                  <ul className="text-xs space-y-1">
                    <li>• <strong>Syncope during exertion</strong> — cardiac until proven otherwise</li>
                    <li>• <strong>Palpitations before syncope</strong> — arrhythmia</li>
                    <li>• <strong>Family history of SCD &lt;50 years</strong> — channelopathy, HCM</li>
                    <li>• <strong>Known structural heart disease</strong> — HCM, ARVC, DCM</li>
                    <li>• <strong>Prior MI or heart failure</strong> — VT risk</li>
                    <li>• <strong>Sudden onset, no prodrome</strong> — arrhythmia</li>
                  </ul>
                </div>
                <div className="p-3 rounded-lg bg-destructive/5 border border-destructive/20">
                  <div className="text-sm font-medium text-destructive mb-2">ECG Red Flags</div>
                  <ul className="text-xs space-y-1">
                    <li>• <strong>QTc &gt;500ms</strong> — LQTS, drug-induced</li>
                    <li>• <strong>Brugada pattern</strong> — coved ST elevation V1-V3 <a href="/images/ecg/brugada-pattern.jpg" target="_blank" className="text-primary hover:underline">[View ECG]</a></li>
                    <li>• <strong>Epsilon waves</strong> — ARVC <a href="/images/ecg/epsilon-wave.jpg" target="_blank" className="text-primary hover:underline">[View ECG]</a></li>
                    <li>• <strong>LBBB with discordant T waves</strong> — HCM</li>
              ...
              <div className="p-3 rounded-lg bg-warning/5 border border-warning/20">
                <div className="text-sm font-medium text-warning mb-2">High-Risk Features Requiring Admission</div>
                <ul className="text-xs space-y-1">
            ...
            <button className="w-full">
              <CardHeader className="pb-2">
                <CardTitle className="text-base flex items-center justify-between">
                  ...
                  {showECGFindings ? <ChevronUp className="w-4 h-4 text-muted-foreground" /> : <ChevronDown className="w-4 h-4 text-muted-foreground" />}
                </CardTitle>
              </CardHeader>
            </button>
          </CollapsibleTrigger>
            ...
            <CardContent className="pt-2 space-y-3">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div className="p-3 rounded-lg bg-muted/30 border border-border/30">
                  ...
                  <ul className="text-xs space-y-1">
                    <li><strong>Long QT:</strong> QTc &gt;450ms (men), &gt;460ms (women)</li>
                    <li><strong>Brugada:</strong> Type 1 coved ST elevation V1-V3</li>
                    <li><strong>CPVT:</strong> Normal resting ECG, VT with exercise</li>
                    <li><strong>Short QT:</strong> QTc &lt;360ms, peaked T waves</li>
                  </ul>
                </div>
                <div className="p-3 rounded-lg bg-muted/30 border border-border/30">
                  <div className="text-sm font-medium text-primary mb-2">Cardiomyopathies</div>
                  <ul className="text-xs space-y-1">
                    <li><strong>HCM:</strong> LVH, Q waves, LBBB with discordant T</li>
                    <li><strong>ARVC:</strong> Epsilon waves, T wave inversions V1-V3</li>
                    <li><strong>DCM:</strong> LBBB, low voltage, nonspecific ST-T</li>
                    <li><strong>Myocarditis:</strong> ST changes, arrhythmias</li>
                  </ul>
                </div>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div className="p-3 rounded-lg bg-muted/30 border border-border/30">
                  ...
                  <ul className="text-xs space-y-1">
                    <li><strong>High-grade AV block:</strong> No P-QRS relationship</li>
                    <li><strong>Bundle branch block:</strong> Wide QRS, typical morphology</li>
                    <li><strong>Bi/Trifascicular block:</strong> RBBB + LAHB/LPHB</li>
                    <li><strong>Alternating BBB:</strong> Very high risk</li>
                  </ul>
                </div>
                <div className="p-3 rounded-lg bg-muted/30 border border-border/30">
                  <div className="text-sm font-medium text-primary mb-2">Pre-excitation</div>
                  <ul className="text-xs space-y-1">
                    <li><strong>WPW:</strong> Short PR, delta wave, wide QRS</li>
                    <li><strong>LGL:</strong> Short PR, no delta wave</li>
            ...
            <button className="w-full">
              <CardHeader className="pb-2">
                <CardTitle className="text-base flex items-center justify-between">
                  ...
                  {showClinicalPearls ? <ChevronUp className="w-4 h-4 text-muted-foreground" /> : <ChevronDown className="w-4 h-4 text-muted-foreground" />}
                </CardTitle>
              </CardHeader>
            </button>
          </CollapsibleTrigger>
            ...
            <CardContent className="pt-2 space-y-3">
              <div className="p-3 rounded bg-primary/5 border border-primary/20 space-y-2">
                <div className="text-xs">
                  ...
                  <span className="text-muted-foreground">Syncope = rapid recovery (&lt;1 min), no postictal; Seizure = postictal confusion, tongue bite, incontinence</span>
                </div>
                <div className="text-xs">
                  <strong className="text-primary">• Exertional syncope:</strong>{" "}
                  <span className="text-muted-foreground">Always cardiac until proven otherwise — echo, consider HCM, AS, VT</span>
                </div>
                <div className="text-xs">
                  <strong className="text-primary">• Young athlete:</strong>{" "}
                  <span className="text-muted-foreground">Screen for HCM, ARVC, Brugada, CPVT — may need sports restriction</span>
                </div>
                <div className="text-xs">
                  <strong className="text-primary">• Normal ECG:</strong>{" "}
                  <span className="text-muted-foreground">Does not exclude channelopathy — CPVT, Brugada may need provocation testing</span>
                </div>
                <div className="text-xs">
                ...
                <div className="text-xs">
                  ...
                  <span className="text-muted-foreground">No warning, sudden onset, may occur supine, often in high-risk patients</span>
                </div>
                <div className="text-xs">
                  <strong className="text-primary">• Workup:</strong>{" "}
                  <span className="text-muted-foreground">ECG (mandatory), echo if structural disease suspected, Holter/event monitor, tilt table if recurrent and unexplained</span>
                </div>
              </div>

              {/* Risk Stratification */}
              <div className="p-3 rounded-lg bg-muted/30 border border-border/30">
                <div className="text-sm font-medium text-foreground mb-2">Risk Stratification (EGSYS Score)</div>
                <div className="text-xs text-muted-foreground mb-2">Higher score = higher risk of cardiac syncope</div>
                <ul className="text-xs space-y-1">
                  <li>• <strong>Palpitations before syncope</strong> +3</li>
                  <li>• <strong>Abnormal ECG and/or heart disease</strong> +3</li>
                  <li>• <strong>Syncope during effort</strong> +2</li>
                  <li>• <strong>Syncope while supine</strong> +2</li>
                  <li>• <strong>Autonomic prodrome (nausea, warmth)</strong> −1</li>
                  <li>• <strong>Predisposing factors (pain, fear)</strong> −1</li>
                </ul>
