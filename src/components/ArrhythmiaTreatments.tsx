...
export const ARRHYTHMIA_TREATMENTS: ArrhythmiaTreatment[] = [
  {
    ...
    treatment: {
      ...
      medications: [
        ...
        },
        {
          ...
          route: "PO",
          frequency: "daily (ER)",
          notes: "Extended release for rate control",
        },
        {
          drug: "Amiodarone",
          dose: "100-200mg",
          route: "PO",
          frequency: "daily",
          notes: "Maintenance dose; 400mg BID x1wk for loading",
        },
        {
          drug: "Apixaban",
          dose: "5mg",
          route: "PO",
          frequency: "BID",
          notes: "2.5mg BID if age ≥80, weight ≤60kg, or Cr ≥1.5",
        },
        {
          drug: "Rivaroxaban",
          dose: "20mg",
          ...
          notes: "15mg daily if CrCl 15-50",
        },
        {
          drug: "Warfarin",
          dose: "2-5mg",
    ...
    electrolytes: {
      ...
      correct: ["K⁺ to 4.0-4.5 mEq/L", "Mg⁺⁺ to >2.0 mg/dL", "Treat thyroid dysfunction"],
    },
    monitoring: [
      ...
      medications: [
        {
          ...
          dose: "0.25mg/kg",
          route: "IV",
          notes: "Over 2 min, then infusion 5-15mg/h",
        },
        {
          drug: "Metoprolol",
          dose: "5mg",
          route: "IV",
          frequency: "q5min x3",
          notes: "For rate control",
        },
        {
          drug: "Ibutilide",
          dose: "1mg",
          route: "IV",
          notes: "Over 10 min; for cardioversion, monitor QT x4h",
        },
        {
          drug: "Apixaban",
          dose: "5mg",
          route: "PO",
          frequency: "BID",
          notes: "Anticoagulation recommended",
        },
      ],
      procedures: [
      ...
      medications: [
        {
          ...
          dose: "6mg → 12mg",
          route: "IV",
          notes: "Rapid push with flush; effect <10 seconds",
        },
        ...
        },
        {
          ...
          route: "PO",
          frequency: "BID",
          notes: "Avoid if structural heart disease",
        },
      ],
      procedures: [
        "Catheter ablation (slow pathway modification for AVNRT)",
        "Accessory pathway ablation (AVRT)",
      ],
    },
    electrolytes: {
      ...
      medications: [
        {
          ...
          notes: "Then 1mg/min x6h, 0.5mg/min x18h",
        },
        { drug: "Lidocaine", dose: "1-1.5mg/kg", route: "IV", notes: "Then 1-4mg/min infusion" },
        {
          ...
          dose: "20-50mg/min",
          route: "IV",
          notes: "Max 17mg/kg; monitor BP and QRS width",
        },
        {
          drug: "Metoprolol",
          dose: "25-200mg",
      ...
      medications: [
        {
          ...
          route: "IV/IO",
          frequency: "q3-5min",
          notes: "First-line vasopressor",
        },
        {
          drug: "Amiodarone",
          dose: "300mg → 150mg",
          route: "IV/IO",
          notes: "After 2nd and 3rd shocks",
        },
        {
          drug: "Lidocaine",
          dose: "1-1.5mg/kg",
    ...
    treatment: {
      ...
      medications: [
        ...
        },
        {
          ...
          route: "PO",
          frequency: "BID",
          notes: "Only if no structural disease",
        },
        {
          drug: "Mexiletine",
          dose: "150-300mg",
  ...
  },
  {
    ...
    treatment: {
      ...
      medications: [
        ...
        },
        {
          ...
          route: "PO",
          frequency: "daily",
          notes: "For VF storm, pregnancy",
        },
      ],
      procedures: [
        "ICD implantation",
        "Ablation (emerging)",
        "Avoid: ajmaline, flecainide provocation (diagnostic only)",
      ],
    },
    electrolytes: {
    ...
    monitoring: [
      "Continuous telemetry if febrile",
      "ICD interrogation",
      ...
      medications: [
        {
          ...
          dose: "2g",
          route: "IV",
          notes: "Over 2-5 min for TdP; repeat x1",
        },
        {
          drug: "Isoproterenol",
          dose: "2-10 mcg/min",
          route: "IV infusion",
          notes: "If bradycardic and TdP",
        },
        {
          drug: "Nadolol",
          dose: "40-80mg",
          route: "PO",
          frequency: "daily",
          notes: "For congenital LQT",
        },
      ],
      procedures: [
        "Temporary pacing (for bradycardic TdP)",
        "ICD implantation",
  ...
  },
  {
    ...
    treatment: {
      ...
      medications: [
        { drug: "Adenosine", dose: "6mg → 12mg", route: "IV", notes: "Only for narrow QRS SVT" },
        {
          ...
          dose: "20-50mg/min",
          route: "IV",
          notes: "For AF with WPW (max 17mg/kg)",
        },
        {
          drug: "Flecainide",
          dose: "100-200mg",
          route: "PO",
          frequency: "BID",
          notes: "If no structural disease, refused ablation",
        },
      ],
    ...
    monitoring: [
      ...
      "Exercise test (intermittent vs persistent)",
      "Holter for asymptomatic",
    ],
  },
  {
    id: "avblock",
      ...
      medications: [
        {
          ...
          route: "IV",
          frequency: "q5min",
          notes: "Max 3mg; may worsen Mobitz II",
        },
        {
          drug: "Dopamine",
          dose: "2-20 mcg/kg/min",
          route: "IV infusion",
          notes: "If atropine ineffective",
        },
        {
          drug: "Epinephrine",
          dose: "2-10 mcg/min",
          route: "IV infusion",
          notes: "If dopamine ineffective",
        },
        {
          drug: "Isoproterenol",
          dose: "2-10 mcg/min",
          route: "IV infusion",
          notes: "For bradycardia; avoid in ischemia",
        },
      ],
      procedures: [
...
export const ELECTROLYTE_ABNORMALITIES: ElectrolyteAbnormality[] = [
  ...
  },
  {
    ...
    treatment: {
      ...
      severe:
        "K⁺ >6.5 or ECG changes: Calcium gluconate + insulin/glucose + albuterol nebulized + hemodialysis",
    },
  },
  {
